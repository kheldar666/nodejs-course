...
// router.get("/orders/invoice/:orderId", isAuth, shopController.getOrderStaticInvoice);

router.get("/orders/invoice/:orderId", isAuth, shopController.getOrderDynamicInvoice);
